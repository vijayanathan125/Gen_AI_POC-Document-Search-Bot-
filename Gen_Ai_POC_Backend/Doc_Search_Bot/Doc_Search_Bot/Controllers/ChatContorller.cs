...
public class ChatController : ControllerBase
{
    ...
    public ChatController(ILogger<ChatController> logger, ExtractTextFromPdf pdfExtractor)
    {
        ...
        var connectionString = "DefaultEndpointsProtocol=https;AccountName=genaipocvj;AccountKey=2cVv6ef9sJwEs/wrf9gHARm1jvPLdOTQiJkmP5wzr30SWYHj9duvE5o7CRM9N9As1nBgVBENqWoa+AStkueI5A==;EndpointSuffix=core.windows.net";

        // OpenAI API Key
        _openAiApiKey = "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";  // Replace with your actual OpenAI API key

        var storageAccount = CloudStorageAccount.Parse(connectionString);
        var blobClient = storageAccount.CreateCloudBlobClient();
        _blobContainer = blobClient.GetContainerReference("genaipocvj");
    }
